...
% parameters
P        = 1;   % distribution expansion length
gridSize = 15;   % volume resolution
delta    = .99;
...
%                                     Ns(end), gridSize, B, beta, eps_p, gamma, g, x_2d, y_2d, sigmaMoment);
    [~, proj_PSWF, weight, SNR] =  GenerateObservationsPSWFFromAspire(paramsName,...
                                Ns(end), gridSize, B, beta, eps_p, gamma, sigmaMoment);
