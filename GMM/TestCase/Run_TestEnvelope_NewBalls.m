...
total_Ns = floor(logspace(4,5.5,5));
svPercentArray = 0.1 * ones(numberOfExpriemntsRepet,1);
filepathFather = 'ResultsGMM/130920 - BallsNew_L15_Beta1_DiffrentNs_01Truncaton/';
